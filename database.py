# database.py (mit neuer Daily-Tabelle)
import os
...
# Tabelle 1: Für die 1-Minuten-Daten (unverändert)
...
# NEUE TABELLE 2: Für die Tages-Daten (Swing Trading)
...
# Tabelle 3: Für die Live-Vorhersagen (unverändert)
predictions = Table(
    'predictions', meta,
