...
def train_all_models():
    ...
    with engine.connect() as conn:
        for symbol in SYMBOLS: # KORREKTE SCHLEIFE
        ...
        for symbol in SYMBOLS: # KORREKTE SCHLEIFE
            ...
            for name, config in STRATEGIES.items():
                ...
                try:
                    ...
                    X_scaled = scaler.transform(X) # Keine .values hier nötig, da das Modell die Namen jetzt kennt
        ...
        for symbol in SYMBOLS: # KORREKTE SCHLEIFE
            ...
            for name, config in STRATEGIES.items():
                ...
                try:
                    ...
                    X_scaled = scaler.transform(X_predict) # Keine .values hier nötig
