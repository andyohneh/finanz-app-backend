...
INITIAL_CAPITAL = 100; TRADE_SIZE_USD = 45; TRANSACTION_COST_PERCENT = 0.001
...
def run_daily_backtest(symbol: str):
    ...
    capital = INITIAL_CAPITAL; position_open = False; trades = []; equity_curve = [{'timestamp': df['timestamp'].iloc[0].strftime('%Y-%m-%d'), 'equity': INITIAL_CAPITAL}]
