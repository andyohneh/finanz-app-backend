# backtester_daily.py (Finale Version für die Tages-Strategie mit korrektem JSON-Export)
import pandas as pd
import numpy as np
import joblib
import os
...
def run_daily_backtest(symbol: str):
    """Führt den Backtest durch und gibt ein Dictionary mit allen KPIs inkl. Kapitalverlauf zurück."""
